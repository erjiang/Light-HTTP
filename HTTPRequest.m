...
- (void)addTarget:(id)target action:(SEL)selector forEvent:(HTTPRequestEvent)event {
    ...
    switch (event) {
        case HTTPRequestEventDidBeginLoading:
            CFDictionarySetValue((__bridge CFMutableDictionaryRef)(self.HTTPRequestEventDidBeginLoadingDictionary), (__bridge void *)(target), (__bridge void *)(NSStringFromSelector(selector)));
            break;
        case HTTPRequestEventDidFinishLoading:
            CFDictionarySetValue((__bridge CFMutableDictionaryRef)(self.HTTPRequestEventDidFinishLoadingDictionary), (__bridge void *)(target), (__bridge void *)(NSStringFromSelector(selector)));
            break;
        case HTTPRequestEventDidFailToLoad:
            CFDictionarySetValue((__bridge CFMutableDictionaryRef)(self.HTTPRequestEventDidFailToLoadDictionary), (__bridge void *)(target), (__bridge void *)(NSStringFromSelector(selector)));
            break;
        default:
            break;
    }
